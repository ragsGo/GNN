...
class MyOwnDataset(InMemoryDataset):
    ...
    def processed_file_names(self):
        ...
        return [f'hot2-data-single-{filename}-{self.use_validation}-{self.num_neighbours}-{self.smoothing}-{self.mode}-{bits}.pt']
...
def load_data_hot2_single(filename, bits=None, num_neighbours=1, smoothing="laplacian", mode="connectivity", use_validation=False):
...
load_data = load_data_hot2_single
