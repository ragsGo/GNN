...
class MyOwnDataset(InMemoryDataset):
    ...
    def processed_file_names(self):
        ...
        return [f'data-parents-{filename}-{self.use_validation}-{self.num_neighbours}-{self.smoothing}-{self.mode}-{bits}.pt']
...
def load_data_rels(filename, bits=None, num_neighbours=1, smoothing="laplacian", mode="connectivity", use_validation=False):
